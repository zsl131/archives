...
import com.zslin.app.service.IProveTemplateService;
...
public class ProveTemplateController {
    ...
    /** 列表 */
    @AdminAuth(name = "模板列表", orderNum = 1, icon="icon-list")
    ...
    @Token(flag=Token.READY)
    @AdminAuth(name="修改模板", orderNum=3, type="2")
    ...
    @AdminAuth(name="删除模板", orderNum=4, type="2")
